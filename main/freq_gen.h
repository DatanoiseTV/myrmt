...
esp_err_t fgen_allocate(const fgen_info_t* finfo, gpio_num_t gpio_num, fgen_resources_t* res);

esp_err_t fgen_free(const fgen_info_t* info, fgen_resources_t* res);
